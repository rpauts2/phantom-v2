...
CREATE TABLE IF NOT EXISTS campaigns (id TEXT PRIMARY KEY, name TEXT NOT NULL, phishlet_id TEXT NOT NULL, ttl_min INTEGER DEFAULT 0, max_uses INTEGER DEFAULT 1, status TEXT DEFAULT '', created_at INTEGER NOT NULL, stop_at INTEGER DEFAULT 0);
...
func Open(path string) (*DB, error) {
	...
	for _, stmt := range []string{
		...
		`ALTER TABLE campaigns ADD COLUMN stop_at INTEGER DEFAULT 0`,
	} {
